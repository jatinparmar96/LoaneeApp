            ...
            <div class=" container-fluid   container-fixed-lg">
                ...
                <div class="card card-transparent">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-10">
                                <h3 class="m-b-30">Add Single Record</h3>
                                        ...
                                        <div class="col-md-12">
                                            <form class="" role="form">
                                                <div class="form-group form-group-default required typehead" id="sample-three">
                                                    ...
                                                    <input class="typeahead form-control sample-typehead" id="search-typeahead" name="lname" type="text" placeholder="Start Typing..." required>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group form-group-default required">
                                                ...
                                                <input type="text" class="form-control" name="Ramt" required>
...
<script>
    ...
    function parseData(data) {
        ...
        data.forEach(function (value, id) {
            array.push(value['name'] + '-' + value['card_number'])
        });
        if (debug) {
            console.log(array);
        }
    ...
    function changeText(type) {
        ...
        if (type==='Percentage')
        {
            $('#repay-amount').html('Period(in Months)');
        }
        if (type==='Days')
        {
            $('#repay-amount').html('Period(in Days)');
        }
    }
</script>
</body>
