...
`
                            <div class="col-lg-3">
                                <div class="row d-flex flex-column mt-5">
                                    <h6>Agent</h6>
                                    <h2 class="m-0 semi-bold"> {{$data->agent_name}}</h2>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <div class="row d-flex flex-column mt-5">
                                    <h6>Phone</h6>
                                    <h2 class="m-0 semi-bold">{{$data->mobile_no}}</h2>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="row d-flex flex-column mt-5">
                                    <h6>Loan Amount</h6>
                                    <h2 class="m-0 semi-bold"><span>₹</span>{{$data->repay_amount}}</h2>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="row d-flex flex-column mt-5">
                                    <h6>Start Date</h6>
                                    <a href="">
                                        <h2 class="m-0 text-error bold">{{$data->start_date}}</h2>
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="row d-flex flex-column mt-5">
                                    <h6>End Date</h6>
                                    <a href="">
                                        <h2 class="m-0 text-error bold">{{$data->end_date}}</h2>
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="row d-flex flex-column mt-5">
                                    <h6>Last Payment</h6>
                                    <h2 class="m-0 semi-bold">{{$data->last_paid_date}}</h2>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="row d-flex flex-column mt-5">
                                    <h6>Next Due</h6>
                                    <h2 class="m-0 semi-bold">{{$data->next_payment_date}}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                                ...
                                <div class="card-body">
                                    <table class="table-bordered bg-white">
                                        ...
                                        <tr style="height: 5px !important;">
                                            ...
                                            <td>
                                                <h3 class="semi-bold  semi-bold"><span>₹</span>{{$data->pending_amount}}
                                                </h3></td>
                                        </tr>
                                        <tr>
                                            <td><h3>Total Pending Amount</h3></td>
                                            <td>
                                                <h3 class="semi-bold  semi-bold"><span>₹</span>{{$data->total_pending_amount}}
                                                </h3></td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td><h3 class="semi-bold  semi-bold"><span>₹</span>{{$data->penalty}}
                                                </h3></td>
                                        </tr>
                                        <tr>
                                            <td><h3>Total Amount to be paid
                                                </h3></td>
                                            <td><h3 class="semi-bold text-danger bold"><span>₹</span>{{$data->total_amount_remaining}}
                                                </h3></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="row d-flex flex-column mt-5">
                                                <button class="btn btn-success text-white toggle-btn"
                                                        ...
                                                        id="btnToggleSlideUpSize" onclick="fixFunction('{{$data->next_payment_date}}')">Pay Bulk Records
                                                </button>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="modalForm" action="{{url('pay-custom-penalty')}}/{{$data->id}}"
                                          role="form">
                                ...
                                <div class="modal-content">
                                    <div class="modal-body text-center m-t-20">
                                        ...
                                        <div class="btn-group-xs">
                                            <a type="button" href="{{route('close_percentage',$data->id)}}"
                    ...
                    <div class="modal fade stick-up" id="bulkPayModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{url('payBulkRecords')}}/{{$data->id}}" role="form"
                                          autocomplete="off">
                                        <div class="row">
                                            <div class="col-md-12">
                    ...
                    <div class="modal fade stick-up" id="extendRecord" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{url('extendRecord')}}/{{$data->id}}" role="form"
                                          autocomplete="off">
                                        <div class="row">
                                            <div class="col-md-12">
