            ...
            <div class=" container-fluid   container-fixed-lg">
                ...
                <div class="card card-transparent">
                    ...
                    <div class="card-body ">
                            ...
                            <div class="col-lg-4 md-m-b-10 sm-m-b-10">
                                ...
                                <div class="widget-17-weather card no-border bg-white no-margin widget-loader-bar">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <h1 class="no-margin p-b-5 bold">{{$loans}}</h1>
                                                <div class="pull-left">
                                                    <h3 class="semi-bold">Total Users</h3>
                                                </div>
                            ...
                            <div class="col-lg-4 md-m-b-10 sm-m-b-10">
                                ...
                                <div class="widget-17-weather card no-border bg-white no-margin widget-loader-bar">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <h1 class="no-margin p-b-5 bold">{{$loan_amount}}</h1>
                                                <div class="pull-left">
                                                    <h3 class="semi-bold">Payment Given</h3>
                                                </div>
                                                <div class="clearfix"></div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-4 md-m-b-10 sm-m-b-10">
                                ...
                                <div class="widget-17-weather card no-border bg-white no-margin widget-loader-bar">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <h1 class="no-margin p-b-5 bold">{{$pending_amount}}</h1>
                                                <div class="pull-left">
                                                    <h3 class="semi-bold">Payment Pending</h3>
                                                </div>
                                                <div class="clearfix"></div>
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            <div class="col-lg-4 md-m-b-10 sm-m-b-10 mt-5">
                                <div class="widget-17-weather card no-border bg-white no-margin widget-loader-bar">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <h1 class="no-margin p-b-5 bold">{{$setting->value}}</h1>
                                                <div class="pull-left">
                                                    <h3 class="semi-bold">Total Penalty Collection</h3>
                                                </div>
                                                <div class="clearfix"></div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-4 md-m-b-10 sm-m-b-10 mt-5">
                                <div class="widget-17-weather card no-border bg-white no-margin widget-loader-bar">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <h1 class="no-margin p-b-5 bold">{{$penalty_amount}}</h1>
                                                <div class="pull-left">
                                                    <h3 class="semi-bold">Pending Penalty</h3>
                                                </div>
                                                <div class="clearfix"></div>
                                            </div>
                                        </div>
