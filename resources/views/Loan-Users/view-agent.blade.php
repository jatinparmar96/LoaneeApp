            ...
            <div class=" container-fluid   container-fixed-lg">
                ...
                <div class="card card-transparent">
                    ...
                    <div class="card-body">
                            <div class="row">
                                <div class="col-lg-2">
                                    <select class="full-width select2-hidden-accessible" onchange="loadData(this.value)" data-init-plugin="select2" tabindex="-1" aria-hidden="true">
